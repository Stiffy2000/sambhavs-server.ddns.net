...
<head>
    ...
    <title>Sambhav's Server - Status</title>
...
<nav role="main">
    <div id="appname">
        <a href="index.php"><span class="icon-gauge"></span>Status</a>
        <a href="<?php echo $Config->get('esm:website'); ?>"><span class="subtitle">v<?php echo $Config->get('esm:version'); ?></span></a>
    </div>
...
-->
        ...
        <div class="box column-left column-33" id="esm-services">
            <div class="box-header">
