...
$blacklistPatterns = array(
	//See whitelist ^^
	getHostnamePattern("pornhub.com"),
	getHostnamePattern("doubleclick.net"),
	getHostnamePattern("Ad.yieldmanager.com"),
	getHostnamePattern("kickass.to"),
	getHostnamePattern("redtube.com"),
	getHostnamePattern("limewire.com"),
	getHostnamePattern("playboy.com"),
	getHostnamePattern("brazzers.com"),
	getHostnamePattern("xvideos.com"),
	getHostnamePattern("cornhub.com"),
	getHostnamePattern("xnxx.com"),
	getHostnamePattern("xhamster.com"),
	getHostnamePattern("youporn.com")
);
...
$startURL = "https://duckduckgo.com/html";
...
if (empty($url)) {
    if (empty($startURL)) {
		die("<html><head><title>What SecURLy?</title></head><body><form onsubmit=\"if (document.getElementById('site').value) { window.location.href='" . PROXY_PREFIX . "' + document.getElementById('site').value; return false; } else { window.location.href='" . PROXY_PREFIX . $landingExampleURL . "'; return false; }\" autocomplete=\"off\"><input id=\"site\" type=\"text\" size=\"50\" /><input type=\"submit\" value=\"Go!\" /></form><p>Sambhav's Server<br>If you paid for this, you were ripped off.</p></body></html>");
    } else {
      $url = $startURL;
    }
